...
//https://multiembed.mov/directstream.php?video_id=tt6791350
 //urlTv: `https://embed.vidsrc.pk/${showType}/${id}/${showSeason}-${showEpisode}` },
      // { name: "Server 2", urlMovie: `https://vidsrc.icu/embed/${showType}/${id}`, urlTv: `https://vidsrc.icu/embed/${showType}/${id}/${showSeason}/${showEpisode}` },
       // { name: "Server 1", urlMovie: `https://moviesapi.club/${showType}/${id}`, urlTv: `https://moviesapi.club/${showType}/${id}-${showSeason}-${showEpisode}` },
              //  { name: "Server 4", urlMovie: `https://vidsrc.cc/v2/embed/${showType}/${id}`, urlTv: `https://vidsrc.cc/v2/embed/${showType}/${id}/${showSeason}/${showEpisode}` },

    { name: "Server 1", urlMovie: `https://vidsrcme.su/embed/${showType}?tmdb=${id}`,urlTv: `https://vidsrcme.su/embed/tv?tmdb=${id}&season=${showSeason}&episode=${showEpisode}` },
            { name: "Server 2", urlMovie: `https://vidsrcme.ru/embed/movie?tmdb=${id}`, urlTv: `https://vidsrcme.ru/embed/${showType}?tmdb=${id}&season=${showSeason}&episode=${showEpisode}` },
    ...
    { name: "Server 5", urlMovie: `https://vidsrc.cc/v3/embed/${showType}/${id}`, urlTv: `https://vidsrc.cc/v3/embed/${showType}/${id}/${showSeason}/${showEpisode}` },
